...
let s:p.normal.middle = [ [ s:transparent, s:transparent ] ]
let s:p.normal.right = [ [ s:nord5, s:nord3 ], [ s:nord5, s:nord3 ], [ s:nord5, s:nord1 ] ]
...
let s:p.inactive.middle = [ [ s:nord5, s:transparent ] ]
...
let s:p.tabline.middle = [ [ s:nord5, s:transparent ] ]
let s:p.tabline.right = [ [ s:nord1, s:nord3 ] ]
let s:p.tabline.tabsel = [ [ s:nord1, s:nord8 ] ]

let g:lightline#colorscheme#nord_transparent#palette = lightline#colorscheme#flatten(s:p)
