...
#
#   This is a modified version, designed to read a lock file if provided
...
usage() {
    ...
    printf "\n"
    printf " -l, --lock [path]\n"
    printf "   Loock file to use\n"
    printf "   Reads the contents of the fole provided and pauses the process if the file contains '1'\n"
    printf "\n\n"
